...
class Login extends StatelessWidget {
  ...
  return http.post(url, body: body).then((http.Response response) {
    ...
    static final LOGINURL = 'http://'+url+':8000/api/auth/login';
static final role = 'http://'+url+':8000/api/user/expert';
  // var data ;
                  ...
                  if (data['user']['role']=='expert') {
                    Navigator.push(
                        ...
                        new MaterialPageRoute(
                          ...
                          builder: (context) => HomePageExpert(email:newPost.email,id: data['user']['id'],)
                    ...
                    Navigator.push(
                        ...
                        new MaterialPageRoute(
                          // builder: (context) => HomePageUser('user'),
                          builder: (context) => HomePageUser(email:newPost.email,userinfo: data),
