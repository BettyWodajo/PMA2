...
class HomePageExpert extends StatefulWidget {
  String email;
  var userinfo;
  HomePageExpert({this.email,this.userinfo});
  @override
...
class HomePageState extends State<HomePageExpert> {
  ...
  static final commentposturl = 'http://10.0.2.2:8000/api/comment';
                ...
                onTap: () {
                  Navigator.push(
                        ...
                        new MaterialPageRoute(
                          ...
                          builder: (context) =>UserOptions(widget.email,widget.userinfo)
            ...
            Card(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  child:
                    new FadeInImage(image: new NetworkImage(data[index]['image']), placeholder: new AssetImage('assets/hospital.jpg'))
