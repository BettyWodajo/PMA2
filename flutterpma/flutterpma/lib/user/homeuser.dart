...
class HomePageUserState extends State<HomePageUser> {
  ...
  Future<String> getData() async {
    var response = await http.get(Uri.encodeFull(jsonplacholder),
          ...
          child: Column(
            children: <Widget>[
              AppBar(
                ...
                trailing: SizedBox(child: Image.asset('assets/emergency-kit.png'),height: 30,),
                onTap: () {},
              ),
                 ListTile(
                title: Text("Available Experts "),
                trailing: SizedBox(child: Image.asset('assets/doctor.png'),height: 30,),
                onTap: () {
